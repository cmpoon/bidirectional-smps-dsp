...
/******************************************************************/
   ...
   ramfuncs            : LOAD = FLASHA,
	...
	Func1  		 		: LOAD = FLASHA,	PAGE = 0,
             	 		//RUN = RAMM0 | RAMM1 | DRAML0,   PAGE = 1,
             	 		RUN = PRAML0, PAGE  = 0
   						LOAD_START(_Func1_loadstart),
   						LOAD_SIZE(_Func1_loadsize),
   						RUN_START(_Func1_runstart)
   						 {
   		rts2800_ml.lib<u_tofd.obj> (.text)
   		rts2800_ml.lib<fd_mpy28.asm.obj> (.text)
   		rts2800_ml.lib<fd_tol28.asm.obj> (.text)
   		rts2800_ml.lib<fs_mpy28.asm.obj>
   		rts2800_ml.lib<fs_tol28.asm.obj>
   		Solar_Lib_IQ.lib <SPLL_1ph_SOGI_IQ.obj> (.text)
   		driverlib.lib <gpio.obj> (.text:_GPIO_toggle)
   		driverlib.lib <gpio.obj> (.text:_GPIO_setHigh)
   		driverlib.lib <gpio.obj> (.text:_GPIO_setLow)
		rts2800_ml.lib<fs_mpy.obj>
		SFRA_IQ_Lib.lib<SFRA_IQ_INJECT.obj>
		SFRA_IQ_Lib.lib<SFRA_IQ_COLLECT.obj>
    }

	// SFRA_IQ_Data : > DRAML0 | RAMM1 | RAMM0 , ALIGN = 64, PAGE = 1
   ...
   .stack			   : RUN = RAMM0,
						 ...
						 RUN_END(_HWI_STKTOP),
						 PAGE = 1
   .ebss               : > DRAML0 | RAMM1 | RAMM0       PAGE = 1
   .esysmem            : > DRAML0 | RAMM1 | RAMM0       PAGE = 1
   .sysmem             : > DRAML0 | RAMM1 | RAMM0       PAGE = 1
   ...
   //IQmath          : load = IQMATH,    PAGE = 0, TYPE = NOLOAD
   //IQmath              : > FLASHA       PAGE = 0            /* Math Code */
	IQmath			:  {} LOAD = FLASHA,	PAGE = 0,
             	 		//RUN = PRAML0, PAGE  = 0
             	 		RUN = RAMM0 | RAMM1 | DRAML0, PAGE  = 1
   						LOAD_START(_IQmath_loadstart),
   						LOAD_SIZE(_IQmath_loadsize),
   						RUN_START(_IQmath_runstart)

iirfilt : > DRAML0 | RAMM1 | RAMM0 , PAGE = 1
iirldb : > DRAML0 | RAMM1 | RAMM0 , PAGE = 1
sigIn : > DRAML0 | RAMM1 | RAMM0 , PAGE = 1
sigOut : > DRAML0 | RAMM1 | RAMM0 , PAGE = 1
